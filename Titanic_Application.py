...
model = pickle.load(open(r"C:\Users\sagha\Downloads\Major Project\Titanic.pkl","rb"))

# Main Function
def main():
    st.title("Titanic Survival Prediction")
    st.image(r"https://i.pinimg.com/736x/46/6a/6c/466a6ccf76c47060c8e94f187d8aa93f--titanic-ii-ships.jpg", caption= 'Titanic', width = 710)
